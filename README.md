ProductOfElems. PHP Tutorials. Simple Input/Output. Arrays. Algorithms. Console Application.
...
ProductOfElems. Занятия по PHP. Простой Ввод/вывод. Массивы. Алгоритмы. Консольное приложение.
...
Разработано в интегрированной среде Apache NetBeans (в редакторе Microsoft Visual Studio).
